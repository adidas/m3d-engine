...
trait LoadConfiguration {
  ...
  private val dateFormat: String =
    configReader.getAsOption[String]("date_format").getOrElse("yyyy-MM-dd")
  ...
  protected val dataType: String =
    configReader.getAsOption[String]("data_type").getOrElse(STRUCTURED)

  protected val addCorruptRecordColumn: Boolean =
    configReader.getAsOption[Boolean]("add_corrupt_record_column").getOrElse(false)
